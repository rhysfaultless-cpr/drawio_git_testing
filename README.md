...
I dislike its closed system, where I need to access source data through their web application.
...
> Rockwell Automation employees have access to Visio, but our customers interacting with docs.clearpathrobotics.com may not have Visio.
...
* There is a `Bezier` checkbox within a line's `Properties`. 
  This produced a form similar to the reference Threat Dragon model.
...
* The built-in `Trust Boundary` shape had odd endpoints that made the diagram more confusing.
